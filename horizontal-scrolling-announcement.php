...
<div class="wrap">
  ...
  <div class="tool-box">
      ...
      <table width="100%" class="widefat" id="straymanage">
        ...
        <tbody>
          <tr class="<?php if ($i&1) { echo'alternate'; } else { echo ''; }?>">
            ...
            <td align="left" valign="middle"><a href='#'><?php echo(stripslashes($data->hsa_text)); ?></a></td>
    ...
    <ul>
    <li><a href="http://www.gopiplus.com/work/2010/07/18/horizontal-scrolling-announcement/" target="_blank">Drag and drop the widget</a></li>
    <li><a href="http://www.gopiplus.com/work/2010/07/18/horizontal-scrolling-announcement/" target="_blank">Add directly in the theme</a></li>
    <li><a href="http://www.gopiplus.com/work/2010/07/18/horizontal-scrolling-announcement/" target="_blank">Short code for pages and posts</a></li>
    </ul>
  </div>
</div>
<?php

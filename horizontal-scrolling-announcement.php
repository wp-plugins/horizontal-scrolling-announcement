...
{
	add_options_page('Apple Mobile Super horizontal scrolling announcement', 'Horizontal Scrolling', 7, __FILE__, 'HSA_admin_options' );
	add_options_page('Apple Mobile', '', 0, "horizontal-scrolling-announcement/horizontal-scrolling-setting.php",'' );
}

<div class="wrap">
  <div class="form-wrap">
    ...
    <form name="hsa_form" method="post" action="">
		...
		<input name="hsa_title" type="text" value="<?php echo $hsa_title; ?>"  id="hsa_title" size="70" maxlength="100">
		...
		<select name="hsa_direction" id="hsa_direction">
			<option value='left' <?php if($hsa_direction == 'left') { echo "selected='selected'" ; } ?>>Left</option>
			<option value='right' <?php if($hsa_direction == 'right') { echo "selected='selected'" ; } ?>>Right</option>
		</select>
		...
		<p>Please enter your CSS attributes for style.</p>
